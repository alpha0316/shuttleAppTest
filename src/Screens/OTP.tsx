   ...
   const handleSubmit = async (e: React.FormEvent) => {
    ...
    return (
        <div className="flex flex-col lg:flex-row h-screen w-screen m-0 p-0 overflow-hidden bg-white">
            ...
            <section className="w-full lg:w-1/2 flex items-start justify-center bg-white py-8 lg:py-0 lg:items-center  md:mb-36">
                <main className="flex flex-col items-start justify-center gap-8 lg:gap-24 w-[90%] md:w-[70%] lg:w-[55%] max-w-md">
                    ...
                    <section className='w-full gap-6 flex flex-col'>
                        <header className="flex flex-col justify-start items-start gap-1 w-full">
                            <p className="text-black text-2xl font-bold">Enter verification code</p>
                       ...
                       <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full mt-2">
                        ...
                        <button
                            type="button"
                            className="text-center text-black/60 text-sm font-normal hover:text-black transition-colors"
                        >
            ...
            <section className="hidden lg:flex w-1/2 h-full bg-neutral-50 items-center justify-center">
                ...
                `}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
                                        <path d="M20.6201 8.45C19.5701 3.83 15.5401 1.75 12.0001 1.75C12.0001 1.75 12.0001 1.75 11.9901 1.75C8.4601 1.75 4.4201 3.82 3.3701 8.44C2.2001 13.6 5.3601 17.97 8.2201 20.72C9.2801 21.74 10.6401 22.25 12.0001 22.25C13.3601 22.25 14.7201 21.74 15.7701 20.72C18.6301 17.97 21.7901 13.61 20.6201 8.45ZM12.0001 13.46C10.2601 13.46 8.8501 12.05 8.8501 10.31C8.8501 8.57 10.2601 7.16 12.0001 7.16C13.7401 7.16 15.1501 8.57 15.1501 10.31C15.1501 12.05 13.7401 13.46 12.0001 13.46Z" fill="black" fillOpacity="0.6" />
                                    </svg>
                                </div>

                                <div className={`flex px-4 py-3 gap-2 bg-white rounded-[16px] items-center border border-black/10 w-[90%]`}>
                                    ...
                                    <input
                                        ...
                                        className={`flex-1 border-none bg-transparent text-[14px] text-black border-neutral-200 outline-none p-0 transition-all duration-300 touch-manipulation`}
                                    />
                        ...
                        <figure className='w-full flex items-center justify-between px-12'>
                            <div className='w-0.5 h-5 bg-neutral-200' />
                            <div className='w-1 h-7 bg-neutral-700' />
                            <div className='w-0.5 h-5 bg-neutral-200' />
                        </figure>
                        ...
                        <div className='relative w-full flex flex-col items-center h-32'>
                            ...
                            >
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                                    <p style={{ fontSize: 14, margin: 0 }}>Brunei</p>
                                    <p style={{ fontSize: 12, margin: 0, color: 'rgba(0,0,0,0.6)' }}>Campus</p>
                                </div>
                            </div>
                    ...
                    <div className='w-full h-0.25 border border-neutral-200 border-dashed' />
                    ...
                    <section className='w-full flex items-start justify-center flex-col'>
                        <section style={{
                            ...
                            {/* Rest of the right section content remains the same */}
                            <div style={{
                                display: 'flex',
                        ...
                        <figure className='w-0.25 h-7 border border-green-600 border-dashed mx-8' />

                        <BusStops />

                        <section className="inline-flex flex-col justify-start items-center gap-[5px] w-full mt-12">
                            <p className="self-stretch text-center justify-start text-black text-3xl font-bold ">Move. Track. Connect.</p>
                            <p className="self-stretch text-center justify-start text-black/50 text-sm font-normal ">Move smarter and stay connected across campus.</p>
                        </section>
                    </section>
                </main>
            </section>
